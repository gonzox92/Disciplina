...
namespace Disciplina.Vistas.Reportes
{
    public partial class Cursos : Form
    {
        ...
        public Cursos(Dictionary<string, string> carreras)
        {
            InitializeComponent();
        ...
        private void txtCurso_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable estudiantes = this.faltas.getFaltasEstudiantesCurso(((KeyValuePair<string, string>)this.txtCurso.SelectedItem).Key);
